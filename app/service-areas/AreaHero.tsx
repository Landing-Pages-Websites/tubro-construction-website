  ...
  return (
    <section id="hero" className={styles.hero} aria-labelledby="area-heading">
      ...
      <div className={styles.heroPhoto}>
        <Image src={IMAGES.capExteriorPaint.src} alt={IMAGES.capExteriorPaint.alt} fill priority sizes="(min-width: 768px) 48vw, 88vw" />
      </div>
      ...
      <a className={styles.photoCaption} href="/interior-exterior-painting"><span>A fresh perspective on home</span><strong>Exterior painting <ArrowUpRight aria-hidden="true" /></strong></a>
    </section>
  );
}
