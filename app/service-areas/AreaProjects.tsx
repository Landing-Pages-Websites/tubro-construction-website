  ...
  return (
    <section id="project-map" className={`${styles.section} ${styles.projects}`} aria-labelledby="projects-heading">
      ...
      <a href="/bathroom-remodeling" className={styles.bathProject}>
        <div className={styles.projectPhoto}><Image src={IMAGES.roomsBathroom.src} alt={IMAGES.roomsBathroom.alt} fill sizes="(min-width: 768px) 32vw, 90vw" /></div>
      ...
      <a href="/general-contractor" className={styles.deckProject}>
        <div className={styles.projectPhoto}><Image src={IMAGES.capDeck.src} alt={IMAGES.capDeck.alt} fill sizes="(min-width: 768px) 53vw, 90vw" /></div>
